...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "bypass.autotvin.dat"
	set constFileTvOut       "bypass.autotvout.dat"
	set constFileHdlTvIn     "bypass.autohdltvin.dat"
	set constFileHdlTvOut    "bypass.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
