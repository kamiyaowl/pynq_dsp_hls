...
wire   [0:0] icmp_ln761_fu_218_p2;
wire   [0:0] or_ln101_fu_258_p2;
...
reg   [0:0] icmp_ln761_reg_335;
reg   [0:0] or_ln101_reg_344;
...
reg   [31:0] reg_182;
wire   [29:0] r_V_fu_188_p4;
reg   [29:0] r_V_reg_301;
wire   [30:0] zext_ln215_fu_198_p1;
reg   [30:0] zext_ln215_reg_306;
wire   [30:0] ret_V_fu_202_p2;
reg   [30:0] ret_V_reg_311;
reg   [31:0] status_V_reg_330;
reg    ap_predicate_op65_readreq_state10;
reg    ap_block_state10_io;
wire   [0:0] xor_ln96_fu_236_p2;
wire   [30:0] ret_V_1_fu_274_p2;
reg   [30:0] ret_V_1_reg_354;
wire    ap_CS_fsm_state16;
reg   [0:0] ap_phi_mux_readyRch_flag_1_phi_fu_142_p6;
reg   [0:0] readyRch_flag_1_reg_138;
reg    ap_predicate_op84_writeresp_state24;
reg    ap_block_state24;
reg   [0:0] ap_phi_mux_readyRch_new_1_phi_fu_157_p6;
reg   [0:0] readyRch_new_1_reg_152;
reg   [0:0] ap_phi_mux_readyLch_flag_1_phi_fu_172_p6;
reg   [0:0] readyLch_flag_1_reg_168;
wire   [63:0] zext_ln544_fu_208_p1;
wire   [63:0] zext_ln544_1_fu_264_p1;
wire   [63:0] zext_ln544_2_fu_279_p1;
wire   [0:0] xor_ln101_fu_241_p2;
wire   [0:0] or_ln96_fu_231_p2;
wire   [0:0] and_ln101_fu_247_p2;
wire   [0:0] xor_ln101_1_fu_252_p2;
reg   [23:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln761_fu_218_p2 == 1'd0) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10) & (or_ln101_fu_258_p2 == 1'd1))) begin
        readyLch_flag_1_reg_168 <= xor_ln96_fu_236_p2;
    end else if ((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (or_ln101_reg_344 == 1'd0) & (icmp_ln761_reg_335 == 1'd0) & (1'b1 == ap_CS_fsm_state24))) begin
        readyLch_flag_1_reg_168 <= 1'd1;
    end else if (((1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10) & (icmp_ln761_fu_218_p2 == 1'd1))) begin
        readyLch_flag_1_reg_168 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln761_fu_218_p2 == 1'd0) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10) & (or_ln101_fu_258_p2 == 1'd1))) begin
        ...
        readyRch_flag_1_reg_138 <= 1'd1;
    end else if (((1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10) & (icmp_ln761_fu_218_p2 == 1'd1))) begin
        readyRch_flag_1_reg_138 <= 1'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln761_fu_218_p2 == 1'd0) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10) & (or_ln101_fu_258_p2 == 1'd1))) begin
        readyRch_new_1_reg_152 <= 1'd1;
    end else if ((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (or_ln101_reg_344 == 1'd0) & (icmp_ln761_reg_335 == 1'd0) & (1'b1 == ap_CS_fsm_state24))) begin
        readyRch_new_1_reg_152 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln761_fu_218_p2 == 1'd0) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        r_V_reg_301 <= {{basePhysAddr_V[31:2]}};
        ret_V_reg_311 <= ret_V_fu_202_p2;
        zext_ln215_reg_306[29 : 0] <= zext_ln215_fu_198_p1[29 : 0];
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (ap_phi_mux_readyLch_flag_1_phi_fu_172_p6 == 1'd1) & (1'b1 == ap_CS_fsm_state24))) begin
        readyLch <= ap_phi_mux_readyRch_new_1_phi_fu_157_p6;
    end
end

always @ (posedge ap_clk) begin
    if ((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (ap_phi_mux_readyRch_flag_1_phi_fu_142_p6 == 1'd1) & (1'b1 == ap_CS_fsm_state24))) begin
...
always @ (*) begin
    if ((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state24))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((or_ln101_reg_344 == 1'd0) & (icmp_ln761_reg_335 == 1'd0) & (1'b1 == ap_CS_fsm_state24))) begin
        ap_phi_mux_readyLch_flag_1_phi_fu_172_p6 = 1'd1;
    end else begin
...
always @ (*) begin
    if (((or_ln101_reg_344 == 1'd0) & (icmp_ln761_reg_335 == 1'd0) & (1'b1 == ap_CS_fsm_state24))) begin
        ap_phi_mux_readyRch_flag_1_phi_fu_142_p6 = 1'd1;
    end else begin
...
always @ (*) begin
    if (((or_ln101_reg_344 == 1'd0) & (icmp_ln761_reg_335 == 1'd0) & (1'b1 == ap_CS_fsm_state24))) begin
        ap_phi_mux_readyRch_new_1_phi_fu_157_p6 = 1'd0;
    end else begin
...
always @ (*) begin
    if (((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (1'b1 == ap_CS_fsm_state24)) | ((physMemPtr_V_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((ap_predicate_op65_readreq_state10 == 1'b1) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10))) begin
        physMemPtr_V_ARADDR = zext_ln544_1_fu_264_p1;
    end else if (((physMemPtr_V_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
        physMemPtr_V_ARADDR = zext_ln544_fu_208_p1;
    end else begin
...
always @ (*) begin
    if ((((ap_predicate_op65_readreq_state10 == 1'b1) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10)) | ((physMemPtr_V_ARREADY == 1'b1) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if ((~((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0)) & (ap_predicate_op84_writeresp_state24 == 1'b1) & (1'b1 == ap_CS_fsm_state24))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((or_ln101_fu_258_p2 == 1'd0) & (icmp_ln761_fu_218_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state10)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state10 : begin
            if (((or_ln101_fu_258_p2 == 1'd0) & (icmp_ln761_fu_218_p2 == 1'd0) & (1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10))) begin
                ap_NS_fsm = ap_ST_fsm_state11;
            end else if (((1'b0 == ap_block_state10_io) & (1'b1 == ap_CS_fsm_state10) & ((or_ln101_fu_258_p2 == 1'd1) | (icmp_ln761_fu_218_p2 == 1'd1)))) begin
...
assign and_ln101_fu_247_p2 = (xor_ln101_fu_241_p2 & lrclk_V_0_data_reg);
...
always @ (*) begin
    ap_block_state10_io = ((ap_predicate_op65_readreq_state10 == 1'b1) & (physMemPtr_V_ARREADY == 1'b0));
end

always @ (*) begin
    ap_block_state24 = ((ap_predicate_op84_writeresp_state24 == 1'b1) & (physMemPtr_V_BVALID == 1'b0));
end

always @ (*) begin
    ap_predicate_op65_readreq_state10 = ((or_ln101_fu_258_p2 == 1'd0) & (icmp_ln761_fu_218_p2 == 1'd0));
end

always @ (*) begin
    ap_predicate_op84_writeresp_state24 = ((or_ln101_reg_344 == 1'd0) & (icmp_ln761_reg_335 == 1'd0));
end
...
assign icmp_ln761_fu_218_p2 = ((status_V_reg_330 == 32'd0) ? 1'b1 : 1'b0);

assign or_ln101_fu_258_p2 = (xor_ln101_1_fu_252_p2 | and_ln101_fu_247_p2);

assign or_ln96_fu_231_p2 = (readyRch | lrclk_V_0_data_reg);

assign physMemPtr_V_AWADDR = zext_ln544_2_fu_279_p1;

assign r_V_fu_188_p4 = {{basePhysAddr_V[31:2]}};

assign ret_V_1_fu_274_p2 = (zext_ln215_reg_306 + 31'd2);

assign ret_V_fu_202_p2 = (zext_ln215_fu_198_p1 + 31'd4);

assign xor_ln101_1_fu_252_p2 = (or_ln96_fu_231_p2 ^ 1'd1);

assign xor_ln101_fu_241_p2 = (readyLch ^ 1'd1);

assign xor_ln96_fu_236_p2 = (lrclk_V_0_data_reg ^ 1'd1);

assign zext_ln215_fu_198_p1 = r_V_fu_188_p4;

assign zext_ln544_1_fu_264_p1 = r_V_reg_301;

assign zext_ln544_2_fu_279_p1 = ret_V_1_reg_354;

assign zext_ln544_fu_208_p1 = ret_V_reg_311;

always @ (posedge ap_clk) begin
    zext_ln215_reg_306[30] <= 1'b0;
end
