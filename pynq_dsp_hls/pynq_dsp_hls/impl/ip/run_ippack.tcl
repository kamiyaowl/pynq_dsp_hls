...
set hdl_module_list {pynq_dsp_hls_faddbkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 basePhysAddr_V W 0x0 "Data signal of basePhysAddr_V" {{0 32 basePhysAddr_V W 0 "Bit 31 to 0 Data signal of basePhysAddr_V"}}} {0x18 monitorSrcL R 0x0 "Data signal of monitorSrcL" {{0 32 monitorSrcL R 0 "Bit 31 to 0 Data signal of monitorSrcL"}}} {0x1c monitorSrcL_ctrl R 0x0 "Control signal of monitorSrcL" {{0 1 monitorSrcL_ap_vld R 0 "Control signal monitorSrcL_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 monitorSrcR R 0x0 "Data signal of monitorSrcR" {{0 32 monitorSrcR R 0 "Bit 31 to 0 Data signal of monitorSrcR"}}} {0x24 monitorSrcR_ctrl R 0x0 "Control signal of monitorSrcR" {{0 1 monitorSrcR_ap_vld R 0 "Control signal monitorSrcR_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 monitorDstL R 0x0 "Data signal of monitorDstL" {{0 32 monitorDstL R 0 "Bit 31 to 0 Data signal of monitorDstL"}}} {0x2c monitorDstL_ctrl R 0x0 "Control signal of monitorDstL" {{0 1 monitorDstL_ap_vld R 0 "Control signal monitorDstL_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 monitorDstR R 0x0 "Data signal of monitorDstR" {{0 32 monitorDstR R 0 "Bit 31 to 0 Data signal of monitorDstR"}}} {0x34 monitorDstR_ctrl R 0x0 "Control signal of monitorDstR" {{0 1 monitorDstR_ap_vld R 0 "Control signal monitorDstR_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 counter_i W 0x0 "Data signal of counter_i" {{0 32 counter_i W 0 "Bit 31 to 0 Data signal of counter_i"}}} {0x40 counter_o R 0x0 "Data signal of counter_o" {{0 32 counter_o R 0 "Bit 31 to 0 Data signal of counter_o"}}} {0x44 counter_o_ctrl R 0x0 "Control signal of counter_o" {{0 1 counter_o_ap_vld R 0 "Control signal counter_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 numOfStage R 0x0 "Data signal of numOfStage" {{0 32 numOfStage R 0 "Bit 31 to 0 Data signal of numOfStage"}}} {0x4c numOfStage_ctrl R 0x0 "Control signal of numOfStage" {{0 1 numOfStage_ap_vld R 0 "Control signal numOfStage_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 configSizePerStage R 0x0 "Data signal of configSizePerStage" {{0 32 configSizePerStage R 0 "Bit 31 to 0 Data signal of configSizePerStage"}}} {0x54 configSizePerStage_ctrl R 0x0 "Control signal of configSizePerStage" {{0 1 configSizePerStage_ap_vld R 0 "Control signal configSizePerStage_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "configReg {base_address 1024 range 1024}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_physMemPtr_V m_axi_extMemPtr_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 8 machine 64 combinational 0 latency 11 II x}
