...
#define XPYNQ_DSP_HLS_AXILITES_ADDR_CONFIGREG_BASE          0x100
#define XPYNQ_DSP_HLS_AXILITES_ADDR_CONFIGREG_HIGH          0x1ff
#define XPYNQ_DSP_HLS_AXILITES_WIDTH_CONFIGREG              32
#define XPYNQ_DSP_HLS_AXILITES_DEPTH_CONFIGREG              64
