...
// ==============================================================
#ifndef __pynq_dsp_hls_fcmpg8j__HH__
#define __pynq_dsp_hls_fcmpg8j__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_fcmpg8j) {
    ...
    SC_CTOR(pynq_dsp_hls_fcmpg8j):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
