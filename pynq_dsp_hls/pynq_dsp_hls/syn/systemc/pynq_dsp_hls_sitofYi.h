...
// ==============================================================
#ifndef __pynq_dsp_hls_sitofYi__HH__
#define __pynq_dsp_hls_sitofYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_sitofYi) {
    ...
    SC_CTOR(pynq_dsp_hls_sitofYi):  ACMP_sitofp_U ("ACMP_sitofp_U") {
