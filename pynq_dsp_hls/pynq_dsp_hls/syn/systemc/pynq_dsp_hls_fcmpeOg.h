...
// ==============================================================
#ifndef __pynq_dsp_hls_fcmpeOg__HH__
#define __pynq_dsp_hls_fcmpeOg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_fcmpeOg) {
    ...
    SC_CTOR(pynq_dsp_hls_fcmpeOg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
