...
// ==============================================================
#ifndef __pynq_dsp_hls_uitodEe__HH__
#define __pynq_dsp_hls_uitodEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_uitodEe) {
    ...
    SC_CTOR(pynq_dsp_hls_uitodEe):  ACMP_uitofp_U ("ACMP_uitofp_U") {
