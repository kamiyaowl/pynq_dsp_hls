...
// ==============================================================
#ifndef __pynq_dsp_hls_sitojbC__HH__
#define __pynq_dsp_hls_sitojbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_sitojbC) {
    ...
    SC_CTOR(pynq_dsp_hls_sitojbC):  ACMP_sitofp_U ("ACMP_sitofp_U") {
