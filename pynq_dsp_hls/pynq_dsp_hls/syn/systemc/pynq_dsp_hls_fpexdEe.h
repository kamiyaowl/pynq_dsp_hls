...
// ==============================================================
#ifndef __pynq_dsp_hls_fpexdEe__HH__
#define __pynq_dsp_hls_fpexdEe__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_fpexdEe) {
    ...
    SC_CTOR(pynq_dsp_hls_fpexdEe):  ACMP_fpext_U ("ACMP_fpext_U") {
