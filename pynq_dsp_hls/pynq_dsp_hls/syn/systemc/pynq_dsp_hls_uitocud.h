...
// ==============================================================
#ifndef __pynq_dsp_hls_uitocud__HH__
#define __pynq_dsp_hls_uitocud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(pynq_dsp_hls_uitocud) {
    ...
    SC_CTOR(pynq_dsp_hls_uitocud):  ACMP_uitofp_U ("ACMP_uitofp_U") {
