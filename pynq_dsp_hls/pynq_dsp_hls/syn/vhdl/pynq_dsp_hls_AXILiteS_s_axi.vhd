...
port (
    ...
    configReg_d0          :in   STD_LOGIC_VECTOR(7 downto 0)
);
...
-- ----------------------- Memory logic ------------------
    ...
    int_configReg_be0    <= SHIFT_LEFT(TO_UNSIGNED(1, 4), TO_INTEGER(UNSIGNED(configReg_address0(1 downto 0))));
    int_configReg_d0     <= UNSIGNED(configReg_d0) & UNSIGNED(configReg_d0) & UNSIGNED(configReg_d0) & UNSIGNED(configReg_d0);
