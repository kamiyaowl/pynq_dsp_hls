...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pynq_dsp_hls_AXILiteS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::m_axi_gen { \
    ...
    delay_budget 7 \ 
    is_flushable 0 \ 
    name {pynq_dsp_hls_physMemPtr_V_m_axi} \
} "
} else {
puts "@W \[IMPL-110\] Cannot find AXI interface model in the library. Ignored generation of AXI interface for 'physMemPtr_V'"
}
}
