...
set portList { 
	...
	{ m_axi_physMemPtr_V_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_AWADDR sc_out sc_lv 32 signal 0 } 
	{ m_axi_physMemPtr_V_AWID sc_out sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_AWLEN sc_out sc_lv 8 signal 0 } 
	{ m_axi_physMemPtr_V_AWSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_physMemPtr_V_AWBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_physMemPtr_V_AWLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_physMemPtr_V_AWCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_AWPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_physMemPtr_V_AWQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_AWREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_AWUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_WVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_WREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_WDATA sc_out sc_lv 32 signal 0 } 
	{ m_axi_physMemPtr_V_WSTRB sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_WLAST sc_out sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_WID sc_out sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_WUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_ARVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_ARREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_ARADDR sc_out sc_lv 32 signal 0 } 
	{ m_axi_physMemPtr_V_ARID sc_out sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_ARLEN sc_out sc_lv 8 signal 0 } 
	{ m_axi_physMemPtr_V_ARSIZE sc_out sc_lv 3 signal 0 } 
	{ m_axi_physMemPtr_V_ARBURST sc_out sc_lv 2 signal 0 } 
	{ m_axi_physMemPtr_V_ARLOCK sc_out sc_lv 2 signal 0 } 
	{ m_axi_physMemPtr_V_ARCACHE sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_ARPROT sc_out sc_lv 3 signal 0 } 
	{ m_axi_physMemPtr_V_ARQOS sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_ARREGION sc_out sc_lv 4 signal 0 } 
	{ m_axi_physMemPtr_V_ARUSER sc_out sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_RVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_RREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_RDATA sc_in sc_lv 32 signal 0 } 
	{ m_axi_physMemPtr_V_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_RUSER sc_in sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_RRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_physMemPtr_V_BVALID sc_in sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_BREADY sc_out sc_logic 1 signal 0 } 
	{ m_axi_physMemPtr_V_BRESP sc_in sc_lv 2 signal 0 } 
	{ m_axi_physMemPtr_V_BID sc_in sc_lv 1 signal 0 } 
	{ m_axi_physMemPtr_V_BUSER sc_in sc_lv 1 signal 0 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"bypass","role":"start","value":"0","valid_bit":"0"},{"name":"bypass","role":"continue","value":"0","valid_bit":"4"},{"name":"bypass","role":"auto_start","value":"0","valid_bit":"7"},{"name":"basePhysAddr_V","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_AXILiteS_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "ARADDR" },"address":[{"name":"bypass","role":"start","value":"0","valid_bit":"0"},{"name":"bypass","role":"done","value":"0","valid_bit":"1"},{"name":"bypass","role":"idle","value":"0","valid_bit":"2"},{"name":"bypass","role":"ready","value":"0","valid_bit":"3"},{"name":"bypass","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bypass_AXILiteS_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.bypass_physMemPtr_V_m_axi_U", "Parent" : "0"}]}
